...
int send_over_network()
{
  ...
  for (it = kl_begin(kl_messages); it != kl_end(kl_messages); it = kl_next(it)) {
    ...
    /*
      ...
      */
    if ((modbus_mode || bacnet_mode || iec61850_mode || iec104_mode || opener_mode) && send_size > 0) {
      ...
      if (modbus_mode)
        ...
        send_size = opener_fix_request_message(fixed_buf, send_size);
    ...
    switch (opt) {
      ...
      case 'P': /* protocol to be tested */
        ...
        if (!strcmp(optarg, "RTSP")) {
          ...
          modbus_mode = 1;
        } else if (!strcmp(optarg, "BACNET")) {
          extract_requests = &extract_requests_bacnet;
          extract_response_codes = &extract_response_codes_bacnet;
          bacnet_mode = 1;
        } else if (!strcmp(optarg, "IEC61850") || !strcmp(optarg, "MMS")) {
          ...
          iec104_mode = 1;
        } else if (!strcmp(optarg, "OPENER") || !strcmp(optarg, "ENIP") ||
                   !strcmp(optarg, "ETHERNETIP") || !strcmp(optarg, "ETHERNET/IP") ||
                   !strcmp(optarg, "CIP")) {
          extract_requests = &extract_requests_opener;
